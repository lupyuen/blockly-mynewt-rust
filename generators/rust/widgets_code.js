...
/**
 * @fileoverview Generating Rust for Widget blocks.
 * @author luppy@appkaki.com (Lee Lup Yuen)
 */
'use strict';

goog.provide('Blockly.Rust.widgets');
...
Blockly.Rust['widgets_defreturn'] = function(block) {
  ...
  returnValue = returnValue ?
    Blockly.Rust.INDENT + returnValue + '.into()\n' : 
    '';
...
Blockly.Rust['widgets_defnoreturn'] = Blockly.Rust['widgets_defreturn'];

Blockly.Rust['widgets_callreturn'] = function(block) {
...
Blockly.Rust['widgets_ifreturn'] = function(block) {
